...
<meta name="robots" content="noindex, nofollow"><title>글로벌 50 가이드북 — 열람 신청</title>
<style>
body{margin:0;min-height:100vh;display:grid;place-items:center;font-family:'Apple SD Gothic Neo','Malgun Gothic',system-ui,sans-serif;background:linear-gradient(135deg,#1e1b4b,#312e81 55%,#1A56DB);color:#0f172a}
.card{background:#fff;border-radius:20px;padding:44px 40px;max-width:420px;width:calc(100% - 40px);box-shadow:0 20px 60px rgba(0,0,0,.35)}
.k{font-size:11px;font-weight:800;letter-spacing:3px;color:#7c3aed;text-transform:uppercase}
h1{font-size:24px;margin:8px 0 6px;letter-spacing:-.5px}
p{font-size:13px;color:#64748b;line-height:1.7;margin:0 0 20px}
label{display:block;font-size:12px;font-weight:700;margin:14px 0 5px;color:#334155}
input{width:100%;box-sizing:border-box;border:1px solid #e2e8f0;border-radius:10px;padding:11px 13px;font-size:14px;outline:none}
input:focus{border-color:#7c3aed}
button{width:100%;margin-top:22px;background:#0f172a;color:#fff;border:0;border-radius:10px;padding:13px;font-size:14px;font-weight:800;cursor:pointer}
button:hover{background:#1e293b}
.err{margin-top:12px;font-size:12px;color:#e11d48;font-weight:700}
.ft{margin-top:16px;font-size:10px;color:#94a3b8;line-height:1.6}
.hp{position:absolute;left:-9999px}
</style></head><body>
<form class="card" method="POST" autocomplete="on">
  <div class="k">Glovek Guidebook</div>
  <h1>글로벌 50<br>첫 12개월을 통과하는 법</h1>
  <p>글로벌 진출 전략 가이드북(온라인 열람 전용)입니다.<br>아래 정보를 입력하시면 바로 열람하실 수 있습니다.</p>
  ...
  <div class="ft">입력하신 정보는 가이드북 열람 및 글로벌 진출 관련 안내 목적에 한해 이용됩니다. 본 콘텐츠는 무단 복제·배포가 금지됩니다.</div>
</form>
</body></html>`,
