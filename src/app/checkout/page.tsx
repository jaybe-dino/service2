          ...
          <div className="kt-card p-6">
            ...
            <div className="mt-4 space-y-2.5">
              <label className="block">
                ...
                <input inputMode="numeric" maxLength={19} value={cardFmt(card.cardNo)}
                  onChange={(e) => setCard((p) => ({ ...p, cardNo: e.target.value.replace(/\D/g, "").slice(0, 16) }))}
                  placeholder="0000 0000 0000 0000" className="w-full rounded-lg border border-[var(--border)] px-3 py-2 text-[13px] tracking-wider" />
              </label>
