...
// GloveK 서비스 소개서 받기 랜딩 (2번 모델). 1번 모델(/consult)은 그대로 유지.
// 차이: 트랙/개런티 카드 제거, 폼=소개서 받기, 기타 문의 제거, 제출 후 소개서 보기 노출.
import { useState, useEffect, useRef } from "react";
import Link from "next/link";
import { Check, Download, FileText, Loader2, ArrowRight } from "lucide-react";
          ...
          <div className="mt-5">
            {DECK_URL ? (
              <a href={DECK_URL} target="_blank" rel="noopener noreferrer"
                ...
                <Download size={15} /> GloveK 서비스 소개서 보기
              </a>
            ) : (
